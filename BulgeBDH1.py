...
if plotchoice == 0:
    plt.hist(np.log10(bd1), bins=50, histtype='step', color='blue', normed=1)
    plt.hist(np.log10(bd2), bins=50, histtype='step', color='red', normed=1)
    plt.hist(np.log10(bd), bins=50, histtype='step', color='black', normed=1)
...
if plotchoice == 2:
    plt.hist(np.log10(r_plot), bins=50, histtype='step', color='black', normed=0)
    plt.xlabel('')
    plt.ylabel('')
    #print 'plotted'
    plt.savefig('BulgeBDH1.png')